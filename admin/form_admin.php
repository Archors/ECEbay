        ...
        <div class="corps">
            ...
            <div class="row">
                ...
                <div class="mx-sm-3 mb-2">
                         ...
                         <input class="form-control form text_form" id="inputPassword2" placeholder="Pseudo">
                </div>
                ...
                <div class="mx-sm-3 mb-2">
                 ...
                 <button type="submit" class="btn_sub"> <span class="btn_sub_text2"> Se Connecter </span> </button>                
