       ...
       <div class="container">
           <div class="row">
               ...
               <form class="form" role="form" action="" methode="post">
                ...
                <input type="text" class="form-control" id="description" name="prenom" placeholder="description" value="">
                   <br>
                   </div>
                <div class="col-md-6">   
                <label>prix: </label>
                ...
                <input type="text" class="form-control" id="pwd" name="pwd" placeholder="pwd" value="">
                   ...
                   <div class="btn_ajouter"><button type="button" class="btn btn-info">Modifier</button></div>
